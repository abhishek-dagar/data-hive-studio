...
const DARK_GLOBE_CONFIG: COBEOptions = {
  ...
  phi: 0,
  theta: 0.3,
  dark: 0.2, // Changed to 0 to make countries more visible
  diffuse: 0.6, // Increased for better visibility
  mapSamples: 16000,
  mapBrightness: 1.5, // Increased brightness
  baseColor: [38 / 255, 39 / 255, 44 / 255], // #26272C - Dark theme base color
  markerColor: [251 / 255, 100 / 255, 21 / 255],
  glowColor: [0.2, 0.2, 0.2], // White glow for better visibility
  markers: [
    { location: [14.5995, 120.9842], size: 0.03 },
    { location: [19.076, 72.8777], size: 0.1 },
    { location: [23.8103, 90.4125], size: 0.05 },
...
export function Globe({
  ...
  const globeConfig = config || (resolvedTheme === 'dark' ? DARK_GLOBE_CONFIG : LIGHT_GLOBE_CONFIG);
